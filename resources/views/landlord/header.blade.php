<header class="py-6 px-4">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <nav class="flex space-x-6 items-center">
            <a href="" class="{{ Request::routeIs('bh.home') ? 'text-blue-500' : 'text-gray-500 hover:text-blue-500' }}">Home</a>
            ...
            <div class="relative">
                ...
                <ul class="absolute left-0 mt-2 w-40 bg-white border border-gray-200 rounded shadow-lg hidden group-hover:block">
                    <li>
                        <a href="{{ route('landlord.logout') }}" class="block px-4 py-2 text-gray-700 hover:text-blue-500">
                            Logout
                        </a>
                    </li>
                </ul>
