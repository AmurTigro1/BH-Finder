            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden"> 
                ...
                <!-- Google Map Display -->
                    ...
                    <div class="flex justify-start space-x-4">
                        ...
                        <a href="{{ route('user-room.show', $bh->id) }}" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-6 rounded-lg transition-all duration-200">View Rooms</a>
                    </div>
                </div>
            </div>
        </div>
